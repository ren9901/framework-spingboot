...
public class JwtTokenHelper implements InitializingBean {
	...
	public String generateToken(String username) {
		...
		return Jwts.builder().setSubject(username).setIssuer(issuer).setIssuedAt(Date.from(now.atZone(ZoneId.systemDefault()).toInstant())).setExpiration(
				Date.from(expireTime.atZone(ZoneId.systemDefault()).toInstant())).signWith(key).compact();
	}
